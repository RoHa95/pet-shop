...
function CardLavazem({data}) {
    ...
    return (
      <div className=" xl:max-w-[262px] xl:h-[397px] group flex flex-col border-2 border-dashed rounded-xl p-5 border-gray-300 hover:border-orange-500 hover:bg-orange-500 hover:bg-opacity-10 items-center justify-between">
        <div className=" flex w-full h-full flex-col items-start justify-between">
          ...
          <span className=" text-gray-500 font-bold text-base xl:text-lg">{name}</span>
        </div>
        <div className=" flex w-full flex-col items-center justify-between xl:gap-y-5">
          <div className="w-full flex items-center justify-between">
            <div className=" text-lg xl:text-xl font-bold text-emerald-400 group-hover:text-orange-500">قیمت:</div>
            <div className=" text-lg xl:text-xl font-bold text-emerald-400 group-hover:text-orange-500">{price}</div>
          </div>
          <div className=" group-hover:bg-orange-500 bg-cyan-600 flex items-center justify-center xl:justify-between w-full py-2 px-2 sm:px-6 gap-x-2  rounded-lg">
            ...
            <div className=" font-bold text-xs xl:text-base text-white ">افزودن به سبد خرید</div>
          </div>
        </div>
      </div>
    );
